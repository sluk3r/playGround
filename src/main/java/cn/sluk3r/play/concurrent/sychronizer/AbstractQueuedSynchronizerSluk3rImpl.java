 ...
 * single atomic <tt>int</tt> value to represent state. Subclasses //wangxc 只能是int， 是不是有些不太方便。
 ...
 * @author Doug Lea
 */
public class AbstractQueuedSynchronizerSluk3rImpl extends AbstractOwnableSynchronizerSluk3rImpl {
     ...
     */
    protected AbstractQueuedSynchronizerSluk3rImpl() { }
     ...
     * AbstractQueuedSynchronizerSluk3rImpl} serving as the basis of a {@link
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
         ...
         */
        final boolean isOwnedBy(AbstractQueuedSynchronizerSluk3rImpl sync) {
            return sync == AbstractQueuedSynchronizerSluk3rImpl.this;
        }

        /**
         * Queries whether any threads are waiting on this condition.
         * Implements {@link AbstractQueuedSynchronizerSluk3rImpl#hasWaiters}.
         *
         ...
         * this condition.
         * Implements {@link AbstractQueuedSynchronizerSluk3rImpl#getWaitQueueLength}.
         *
         * @return the estimated number of waiting threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *         returns {@code false}
         ...
         * Implements {@link AbstractQueuedSynchronizerSluk3rImpl#getWaitingThreads}.
         *
         * @return the collection of threads
         * @throws IllegalMonitorStateException if {@link #isHeldExclusively}
         *         returns {@code false}
    ...
    static {
        try {
            stateOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizerSluk3rImpl.class.getDeclaredField("state"));
            headOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizerSluk3rImpl.class.getDeclaredField("head"));
            tailOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizerSluk3rImpl.class.getDeclaredField("tail"));
